...
class DvdManager extends Manager
{
    ...
    public function getList() : array
    {
        ...
        foreach($r1 as $dvd)
        {
            ...
            $lesDvd[$dvd['id']] = new Dvd($dvd['id'], $dvd['titre'], $dvd['image'], $dvd['commandeEnCours'], $lesPublics[$dvd['idPublic']], $dvd['synopsis'], $dvd['réalisateur'],$dvd['duree'], $dvd['studio'], $dvd['genre'], $dvd['date']);
     ...
     * @return Livre
     */
    public function getDvdById(int $id) : Dvd
    {
