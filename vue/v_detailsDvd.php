...
<body>
<div class="container">
<h2>Détails du Dvd "<?php echo $doc->getTitre()?>"</h2>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Réalisateur : <?= $doc->getRealisateur() ?></p>
                            <p class="card-text">Studio : <?= $doc->getStudio() ?></p>
                            <p class="card-text">Genre : <?= $doc->getGenre() ?></p>
                            <p class="card-text">Date de sortie : <?= $doc->getDateSortie() ?></p>
                ...
                <div class="tab-content">
                        ...
                        ?>
                                <div class="card numeroDetails">
                                    ...
                                    <div class="form-group ml-auto d-flex justify-content-between">
                                        ...
                                        ?>
                                        <button class="reserverBtn Reserver" onclick="afficheModale('<?php echo $NumeroEx ?>', '<?php echo $idDocument ?>')">Réserver ce numéro</button>
                                    </div>
                                </div>
                        <?php }
                            }
                    ...
                    <div id="myPopup" class="popup-overlay">
                        <div class="popup-content">
                            <p>Êtes-vous sûr de vouloir réserver ce dvd ?</p>
                            <div class="controls">
