    ...
    <div class="card-body">
        <form method="POST" action="?action=hist_pret">
            <div class="group_H">
                ...
                <div class="form-group col-md-1 modHisto"></div>
                <div class="form-group col-md-2 modHisto">
                    <select class="form-control" name="searchType1" id="searchType" required >
                ...
                <div class="form-group col-md-3 modHisto">
                    <select class="form-control" name="searchType1" id="searchType" required >
                        <option value="tout_mots" selected>Tout les mots</option>
                        <option value="exp_exacte" >Expression exacte</option>
                    </select>
                </div>
                <div class="form-group col-md-6 modHisto">
                    <input id="searchText" name="searchText1" class="form-control" placeholder="Saisissez les termes de votre recherche." type="text">
                </div>

            </div>
            <div class="form-row histo_form">
                <div class="form-group col-md-1 modHisto">
                    <select class="form-control" name="operateur1" id="searchType" required >
                ...
                <div class="form-group col-md-2 modHisto">
                    <select class="form-control" name="searchType2" id="searchType" required >
                        <option value="tout" selected>Tout</option>
                        <option value="titre" >Titre</option>
                        <option value="auteur" >Auteur</option>
                        <option value="sujet" >Sujet</option>
                ...
                <div class="form-group col-md-6 modHisto">
                    <input id="searchText" name="searchText2" class="form-control" placeholder="Saisissez les termes de votre recherche." type="text">
                </div>

            </div>
            <div class="form-row histo_form">
                <div class="form-group col-md-1 modHisto">
                    <select class="form-control" name="operateur2" id="searchType" required >
                        <option value="et" selected>Et</option>
                        <option value="ou" >Ou</option>
                        <option value="sauf" >Sauf</option>
                    </select>
                ...
                <div class="form-group col-md-2 modHisto">
                    <select class="form-control" name="searchType3" id="searchType" required >
                        <option value="tout" selected>Tout</option>
                        <option value="titre" >Titre</option>
                        <option value="auteur" >Auteur</option>
                        <option value="sujet" >Sujet</option>
                ...
                <div class="form-group col-md-6 modHisto">
                    <input id="searchText" name="searchText3" class="form-control" placeholder="Saisissez les termes de votre recherche." type="text">
                </div>
            ...
            <div class="lancer_search">
                <button type="submit" name="recherche_pret" class="btn btn-primary col-md-2 btn_Histo"><span class="glyphicon glyphicon-floppy-disk"></span>Recherche</a>
            </div>
        </form>
